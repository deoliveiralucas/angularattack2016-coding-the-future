...
* `git clone git@github.com:rumblex/angularattack2016-coding-the-future.git`

* `cd angularattack2016-coding-the-future`
...
If you receive an error message `"You do not have permission to publish to coding-the-future.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add a22.daniela@gmail.com,wesleycrz@hotmail.com,94oliveira.lucas@gmail.com`
